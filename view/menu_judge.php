...
<div id="menu">
    <ul>
        ...
        <ul>
            <li><a href="../controller/ju_igworkshop.php">In-going Design Thinking workshops</a></li>
            <li><a href="../controller/ju_deliveredworkshop.php">Delivered Design Thinking workshops</a></li>
        </ul>
        </li>
